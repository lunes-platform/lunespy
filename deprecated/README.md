...
`lunespy.stateChangesForAddress(address, limit = 1000):` get the last <limit> (with a default of 1000) state changes for the given address
...
## License
Code released under the [MIT License](https://github.com/LunesPy/LunesPy/blob/master/LICENSE).
