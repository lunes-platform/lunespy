...
from .oracle import *
from .ParallelLunesPy import *

class ParallelLunesPy(object):
    def __init__(self):
        ...
        self.OFFLINE = False
        self.NODE = 'https://nodes.lunesnodes.com'
        ...
        self.CHAIN = 'mainnet'
        self.CHAIN_ID = 'W'
        self.MATCHER = 'https://matcher.lunes.exchange'
        self.MATCHER_PUBLICKEY = ''

        self.DATAFEED = 'http://marketdata.lunesplatform.com'
...
class LunesPyException(ValueError):
    pass