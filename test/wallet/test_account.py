...
def test_validate_address_testnet(account_from_new_seed_testnet):
...
def test_create_account_from_seed_mainnet(account_from_seed_mainnet):
    assert validate_address(chain=1, address=account_from_seed_mainnet.address) == True
...
def test_create_account_from_seed_testnet(account_from_seed_testnet):
    assert validate_address(0, account_from_seed_testnet.address) == True
